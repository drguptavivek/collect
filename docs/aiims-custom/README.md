...
> **Version**: v2025.3.3-AIIMS-RC2-DEV
> **Branch**: `vg-work`
...
- [aiims_vs_standard_boundary.md](01-ARCHITECTURE/aiims_vs_standard_boundary.md) - Custom vs Core boundaries
...
- [AIIMS_DEVELOPER_CHEATSHEET.md](AIIMS_DEVELOPER_CHEATSHEET.md) - Flashcard-style quick reference
- [AIIMS_PROJECT_KNOWLEDGE.md](AIIMS_PROJECT_KNOWLEDGE.md) - High-level project context
...
| `aiims_auth_prefs` | Encrypted storage for session metadata and PIN hashes. |
