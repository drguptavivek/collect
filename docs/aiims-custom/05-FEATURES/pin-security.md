# PIN Security System - AIIMS ODK Collect

> Last Updated: 2025-12-28

This document details the PIN security implementation in AIIMS ODK Collect.

---

## Overview

The AIIMS fork implements a mandatory 4-digit PIN security layer on top of server authentication:
...
**Location**: `aiims_auth_module/.../utils/AiimsAppLock.kt`
...
**Location**: `aiims_auth_module/.../utils/PinManager.kt`
...
**Location**: `aiims_auth_module/.../activities/PinEntryActivity.kt`
...
**Location**: `aiims_auth_module/.../activities/SetupPinActivity.kt`
...
**Location**: `aiims_auth_module/.../activities/ChangePinActivity.kt`
...
**Cause**: `AiimsAppLock` not registered

**Solution**: Check `Collect.onCreate()` for:
```kotlin
registerActivityLifecycleCallbacks(AiimsAppLock())
```
