...
This document outlines the accessibility standards and features implemented in the MEDRES ODK Collect fork, targeting **WCAG 2.1 Level AA** compliance for the custom authentication and security flows.

---

## 1. Visual & Contrast
- **Color Contrast**: All text and meaningful UI elements meet the mandatory **4.5:1** contrast ratio (Standard) or **3:1** (Large text).
- **Dark Mode Support**: MEDRES-specific screens (Login, PIN, Settings) are fully themed for dark mode, ensuring consistent readability without eye strain.
