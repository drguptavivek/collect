...
import org.aiims.odk.auth.R
import org.aiims.odk.auth.databinding.ActivityAiimsQrScannerBinding
...
/**
 * AIIMS QR Scanner Activity
 *
 * Standalone QR scanner for AIIMS using CameraX and Google ML Kit.
 ...
 */
class AiimsQrScannerActivity : AppCompatActivity() {

    private lateinit var binding: ActivityAiimsQrScannerBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAiimsQrScannerBinding.inflate(layoutInflater)
        ...
        try {
            ...
            barcodeScanner.process(image)
                .addOnSuccessListener { barcodes ->
                    ...
                    Toast.makeText(this, R.string.aiims_invalid_qr_code, Toast.LENGTH_LONG).show()
                }
    ...
    private fun handleQrCodeData(qrData: String) {
        ...
        lifecycleScope.launch {
            try {
                ...
                Toast.makeText(
                    this@AiimsQrScannerActivity,
                    R.string.aiims_settings_imported_successfully,
                    Toast.LENGTH_SHORT
                ).show()
                ...
                Toast.makeText(
                    this@AiimsQrScannerActivity,
                    R.string.aiims_invalid_qr_code,
                    Toast.LENGTH_LONG
                ).show()
                isProcessing = false
            }
    ...
    private fun showPermissionDeniedDialog() {
        AlertDialog.Builder(this)
            .setTitle(R.string.aiims_camera_permission_required)
            .setMessage(R.string.aiims_camera_permission_message)
            .setPositiveButton(R.string.aiims_ok) { _, _ ->
                finish()
            }
            .setCancelable(false)
            .show()
