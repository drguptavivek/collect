...
import edu.aiims.medresodk.auth.databinding.ActivityPinEntryBinding
...
class PinEntryActivity : MedresBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkAndRequestPermissions()
                        ...
                        if (!pinManager.isPinSet()) {
                            ...
                            intent.setClass(this@PinEntryActivity, edu.aiims.medresodk.auth.activities.MedresLoginActivity::class.java)
        ...
        lifecycleScope.launch {
            ...
            authManager.authState.collect { state ->
                ...
                if (state == edu.aiims.medresodk.auth.managers.AuthState.LOGGED_OUT) {
    ...
    private fun observeTokenExpiry() {
            ...
            kotlinx.coroutines.flow.combine(
                ...
                if (expiryTime > 0 || isInGrace) {
                    ...
                    if (isExpired) {
                        ...
                        binding.expiryReminderCard.setCardBackgroundColor(ContextCompat.getColor(this@PinEntryActivity, edu.aiims.medresodk.auth.R.color.medres_error_container))
                        binding.expiryReminderCard.strokeColor = ContextCompat.getColor(this@PinEntryActivity, edu.aiims.medresodk.auth.R.color.medres_error)
                        binding.expiryReminderText.text = "⚠️ Session Expired (Offline Grace)"
                        binding.expiryReminderText.setTextColor(ContextCompat.getColor(this@PinEntryActivity, edu.aiims.medresodk.auth.R.color.medres_error))
                        val gracePeriodMsg = "Final auto-logout in: $timeStr"
                        binding.expiryTimeText.text = gracePeriodMsg
                        binding.expiryTimeText.setTextColor(ContextCompat.getColor(this@PinEntryActivity, edu.aiims.medresodk.auth.R.color.medres_error))
                        binding.refreshTokenButton.setTextColor(ContextCompat.getColor(this@PinEntryActivity, edu.aiims.medresodk.auth.R.color.medres_error))
                        // Announce for screen readers
                        binding.expiryReminderCard.announceForAccessibility(getString(edu.aiims.medresodk.auth.R.string.medres_accessibility_grace_period, timeStr))
                    } else {
                        // NORMAL / EXPIRING SOON Styling
                        val colorAttr = if (expiringSoon) edu.aiims.medresodk.auth.R.color.offline_text else edu.aiims.medresodk.auth.R.color.medres_on_surface_variant
                        val bgColorAttr = if (expiringSoon) edu.aiims.medresodk.auth.R.color.offline_background else edu.aiims.medresodk.auth.R.color.medres_surface_variant
                        val strokeColorAttr = if (expiringSoon) edu.aiims.medresodk.auth.R.color.offline_border else edu.aiims.medresodk.auth.R.color.gray_medium
                        ...
                        binding.expiryReminderText.text = if (expiringSoon) getString(edu.aiims.medresodk.auth.R.string.medres_token_expiry_reminder) else getString(edu.aiims.medresodk.auth.R.string.medres_token_status_title)
                        binding.expiryReminderText.setTextColor(ContextCompat.getColor(this@PinEntryActivity, colorAttr))
                        binding.expiryTimeText.text = getString(edu.aiims.medresodk.auth.R.string.medres_token_expires_in, timeStr)
            ...
            authManager.serverTimeDifferenceMs.collect { diffMs ->
                if (kotlin.math.abs(diffMs) > 30 * 60 * 1000L) { // > 30 minutes difference
                    ...
                    binding.expiryReminderText.setTextColor(
                        ContextCompat.getColor(this@PinEntryActivity, edu.aiims.medresodk.auth.R.color.medres_error)
                    )
                } else {
                    ...
                    binding.expiryReminderText.text = getString(edu.aiims.medresodk.auth.R.string.medres_token_status_title)
                    binding.expiryReminderText.setTextColor(
                        ContextCompat.getColor(this@PinEntryActivity, edu.aiims.medresodk.auth.R.color.medres_on_surface_variant)
                    )
                }
            }
        }
        ...
        binding.refreshTokenButton.setOnClickListener {
            ...
            lifecycleScope.launch {
                ...
                val intent = Intent(this@PinEntryActivity, MedresLoginActivity::class.java)
        ...
        lifecycleScope.launch {
            ...
            authManager.currentUser.collect { user ->
                ...
                user?.let {
                    ...
                    binding.userTextView.text = getString(edu.aiims.medresodk.auth.R.string.medres_welcome_back_user, it.username)
    ...
    private fun attemptPinEntry() {
        ...
        when {
            pin.isEmpty() -> {
                val errorMsg = getString(edu.aiims.medresodk.auth.R.string.medres_error_pin_required)
        ...
        lifecycleScope.launch {
            ...
            if (pinManager.isMaxAttemptsReached()) {
                val errorMsg = getString(edu.aiims.medresodk.auth.R.string.medres_error_too_many_attempts)
            ...
            if (pinManager.verifyPin(pin)) {
                ...
                Toast.makeText(
                    ...
                    getString(edu.aiims.medresodk.auth.R.string.medres_pin_success),
                ...
                if (pinManager.isMaxAttemptsReached()) {
                    ...
                    Toast.makeText(
                        ...
                        getString(edu.aiims.medresodk.auth.R.string.medres_error_max_attempts_reached),
                    ...
                    val errorMsg = getString(edu.aiims.medresodk.auth.R.string.medres_error_incorrect_pin_attempts, attemptsLeft)
                    Toast.makeText(this@PinEntryActivity, errorMsg, Toast.LENGTH_SHORT).show()
                    // Announce for screen readers
                    binding.root.announceForAccessibility(getString(edu.aiims.medresodk.auth.R.string.medres_accessibility_pin_error, attemptsLeft))
    ...
    private fun forgotPin() {
        ...
        Toast.makeText(
            ...
            getString(edu.aiims.medresodk.auth.R.string.medres_session_expired),
    ...
    private fun updatePermissionStatusUI() {
        ...
        if (hasLocation) {
            ...
            binding.locationStatusView.text = getString(edu.aiims.medresodk.auth.R.string.medres_location_access_granted)

            binding.locationStatusView.setTextColor(ContextCompat.getColor(this, edu.aiims.medresodk.auth.R.color.medres_success))

        } else {

            binding.locationStatusView.text = getString(edu.aiims.medresodk.auth.R.string.medres_location_access_required)

            binding.locationStatusView.setTextColor(ContextCompat.getColor(this, edu.aiims.medresodk.auth.R.color.medres_error))
        ...
        if (android.os.Build.VERSION.SDK_INT >= 33) {
            ...
            if (hasNotif) {
                ...
                binding.notificationStatusView.text = getString(edu.aiims.medresodk.auth.R.string.medres_notifications_enabled)

                binding.notificationStatusView.setTextColor(ContextCompat.getColor(this, edu.aiims.medresodk.auth.R.color.medres_success))

            } else {

                binding.notificationStatusView.text = getString(edu.aiims.medresodk.auth.R.string.medres_notifications_disabled)

                binding.notificationStatusView.setTextColor(ContextCompat.getColor(this, edu.aiims.medresodk.auth.R.color.medres_error))
