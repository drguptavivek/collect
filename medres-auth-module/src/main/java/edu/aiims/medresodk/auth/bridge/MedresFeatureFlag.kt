package edu.aiims.medresodk.auth.bridge
...
/**
 * Manages MEDRES authentication feature flags.
 *
 * This class controls whether MEDRES authentication is enabled and allows
 * runtime toggling of authentication features without code changes.
 */
object MedresFeatureFlag {

    /**
     * Check if MEDRES authentication is enabled.
     *
     * @param context Application context
     * @return true if MEDRES authentication is enabled
     */
    fun isEnabled(context: Context): Boolean {
        return getPreferences(context)
            .getBoolean(MedresConstants.KEY_MEDRES_AUTH_ENABLED, false)
    }

    /**
     * Enable or disable MEDRES authentication.
     *
     * @param context Application context
    ...
    fun setEnabled(context: Context, enabled: Boolean) {
        getPreferences(context)
            .edit()
            .putBoolean(MedresConstants.KEY_MEDRES_AUTH_ENABLED, enabled)
            .apply()
    }
    ...
    fun isDebugEnabled(context: Context): Boolean {
        return getPreferences(context)
            .getBoolean(MedresConstants.KEY_DEBUG_MODE, false)
    }
    ...
    fun setDebugEnabled(context: Context, enabled: Boolean) {
        getPreferences(context)
            .edit()
            .putBoolean(MedresConstants.KEY_DEBUG_MODE, enabled)
            .apply()
    }

    /**
     * Check if this is the first launch with MEDRES authentication.
     *
     * @param context Application context
    ...
    fun isFirstLaunch(context: Context): Boolean {
        return getPreferences(context)
            .getBoolean(MedresConstants.KEY_FIRST_LAUNCH, true)
    }
    ...
    fun setFirstLaunchComplete(context: Context) {
        getPreferences(context)
            .edit()
            .putBoolean(MedresConstants.KEY_FIRST_LAUNCH, false)
            .apply()
    }
