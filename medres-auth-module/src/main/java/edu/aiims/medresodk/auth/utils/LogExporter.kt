...
import edu.aiims.medresodk.auth.analytics.MedresFileLogger
    ...
    suspend fun exportLogs(context: Context, settingsProvider: SettingsProvider): File? {
        return withContext(Dispatchers.IO) {
            try {
                ...
                val zipFileName = "MedresLogs_$timeStamp.zip"
            ...
            try {
                ...
                val contentValues = android.content.ContentValues().apply {
                    ...
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.Q) {
                        put(android.provider.MediaStore.MediaColumns.RELATIVE_PATH, "Download/MEDRES_Logs")
