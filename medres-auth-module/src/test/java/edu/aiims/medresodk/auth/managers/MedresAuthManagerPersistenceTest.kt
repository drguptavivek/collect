...
class MedresAuthManagerPersistenceTest {
    ...
    private lateinit var secureStorage: edu.aiims.medresodk.auth.storage.FakeMedresSecureStorage
    ...
    fun setUp() {
        ...
        secureStorage = edu.aiims.medresodk.auth.storage.FakeMedresSecureStorage()
